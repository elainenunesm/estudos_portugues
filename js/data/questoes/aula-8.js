...
/**
 * AULA-8.JS — Aula 8: Aprenda a identificar os termos em ordem invertida
  ...
  exemplo: [
    ...
    },
    {
      ...
      caixa: {
        ...
        perguntas: [
          'O sujeito "o trem" vem <strong class="destaque">depois</strong> do verbo — <strong class="destaque">ordem inversa</strong>.',
        ],
      },
    },
    {
  ...
  checagem: [
    {
      ...
      opcoes: [
        ...
        'Uma oração em que o verbo se encontra deslocado.',
    ...
    },
    {
      ...
      referencia:   ['Restam', 'poucas', 'vagas', '.'],
      banco:        ['restam', 'Poucas', 'vagas'],
      ordemCorreta: [1, 2, 0],
      feedback:     '"Poucas vagas restam." — sujeito ("poucas vagas") antes do verbo ("restam"): ordem direta.',
    },
    {
      titulo:    'Identifique o verbo, o sujeito e o predicado (ordem invertida).',
    ...
    {
      titulo:       'Reescreva a frase na ordem direta (sujeito antes do verbo).',
      referencia:   ['Sobrou', 'pouco', 'tempo', '.'],
      banco:        ['sobrou', 'Pouco', 'tempo'],
      ordemCorreta: [1, 2, 0],
      feedback:     '"Pouco tempo sobrou." — sujeito ("pouco tempo") antes do verbo ("sobrou"): ordem direta.',
    },
    {
      titulo:    'Identifique o verbo, o sujeito e o predicado (ordem invertida).',
    ...
    {
      titulo:       'Reescreva a frase na ordem direta (sujeito antes do verbo).',
      referencia:   ['Aconteceram', 'fatos', 'estranhos', 'naquela', 'noite', '.'],
      banco:        ['naquela', 'aconteceram', 'Fatos', 'noite', 'estranhos'],
      ordemCorreta: [2, 4, 1, 0, 3],
      feedback:     '"Fatos estranhos aconteceram naquela noite." — sujeito ("fatos estranhos") antes do verbo ("aconteceram"): ordem direta.',
    },
    {
